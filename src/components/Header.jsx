...
<div className="flex gap-4" >
  ...
  <select name="dollar" id="dollar" className=" bg-transparent capitalize  " >
...
<div className="py-4 flex flex-col sm:flex-row  justify-between text-primary	 capitalize  items-center  ">
<div className="flex flex-col sm:flex-row gap-2 justify-between sm:gap-8 items-center">
<p className="text-[#0D0E43 ] sm:flex-row text-4xl font-bold ">hekto</p>
</div>
...
<form className="flex  items-center" >
  <input className=" border focus:border-secondary border-black  focus:rounded focus:outline-none" type="search" />
 <button className="bg-secondary p-1" ><AiOutlineSearch className=" text-white " />  </button> 
</form>
